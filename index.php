...
$faqs = [
  ...
  [
    ...
    <h3 class='span'>Stabilire il paese associato al tuo account</h3> 
    <br>
...
<head>
  ...
  <!-- Importo Roboto Font da Google font -->
  <link rel="preconnect" href="https://fonts.googleapis.com">
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
  <link href="https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;0,900;1,100;1,300;1,400;1,500;1,700;1,900&display=swap" rel="stylesheet"> 

  <!-- Includo il foglio di stile CSS -->
...
<body>
  ...
  <main>
    <div class="container">
      <?php 
      foreach($faqs as $faq){ ?>
        <h2 class="faq-question"><?php echo $faq['question']; ?></h2>
        <div class="faq-answer"><?php echo $faq['answer']; ?></div> <?php
      } ?>
    </div>
  </main>
